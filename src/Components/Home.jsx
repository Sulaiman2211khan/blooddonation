  ...
  return (
    ...
    <div className='relative py-3 border shadow-md shadow-black   flex items-center justify-between px-10 '>
       <div className='flex items-center '>
        ...
        <div>
      <input
        class="flex h-10 w-[250px] outline-none border-none bg-gray-100 rounded-md bg-gray-100 px-3 py-2 text-sm placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
        type="text"
        placeholder="Serach"
      />
    </div>
