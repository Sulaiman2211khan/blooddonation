    ...
    <div className="max-w-md mx-auto bg-white p-6 mt-10 mb-2 shadow-lg shadow-cyan-500/100">
      ...
      <form className="space-y-4">
        <div>
          ...
          <input type="text" id="full-name" required className="border border-gray-300 rounded-md px-3 py-2 w-full" />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="number" id="age"  required className="border border-gray-300 rounded-md px-3 py-2 w-full" />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="tel" id="phone-number" required className="border border-gray-300 rounded-md px-3 py-2 w-full" />
        </div>
        <div>
          <label htmlFor="email-address" className="block font-medium">Full Address:</label>
          <input type="email" id="email-address" required  className="border border-gray-300 rounded-md px-3 py-2 w-full" />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="number" id="blood-packet" required  className="border border-gray-300 rounded-md px-3 py-2 w-full" />
        </div>
        <div>
        ...
        <div>
          <label htmlFor="request-duration-hours" className="block font-medium">Request Duration (Hours):</label>
          <input type="number" id="request-duration-hours" required  className="border border-gray-300 rounded-md px-3 py-2 w-full" placeholder="Enter duration in hours" />
        </div>
        <div>
          <label htmlFor="request-duration-time" className="block font-medium">Request Duration (Time):</label>
