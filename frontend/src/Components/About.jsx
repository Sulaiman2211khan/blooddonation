...
const About = () => {
  return (
    <>
      <div class=" relative flex items-center justify-center overflow-hidden z-50 bg-slate-200">
            ...
            <div class="relative">
                <div class="lg:max-w-xl lg:pr-5 relative z-40">
                    ...
                    <h2 class="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                        We make you look
                        <span class="my-1 inline-block border-b-8 border-g4  px-4 font-bold text-g4 animate__animated animate__flash">different</span>
                    </h2>
    ...
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRS5bG5OskTep-ohDr05cFrZucK6eiMOHH5y_evOtfgEw&s" class="w-full h-auto" alt="Image description"/>
</div>

            </div>
        </div>
    </div>
    <div class="hidden text-9xl varien absolute top-6 left-1/4 text-g/10 z-40">About Us</div>
